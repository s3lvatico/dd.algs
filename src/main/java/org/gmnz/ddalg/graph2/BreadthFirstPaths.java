 ...
 * to every other vertex in an undirected SGraph.
 * <p>
 * This implementation uses breadth-first search.
 * The constructor takes time proportional to <em>V</em> + <em>E</em>,
 * where <em>V</em> is the number of vertices and <em>E</em> is the number of
 * edges.
 * Each call to {@link #distTo(int)} and {@link #hasPathTo(int)} takes constant
 * time;
 * each call to {@link #pathTo(int)} takes time proportional to the length
 * of the path.
 * It uses extra space (not including the SGraph) proportional to <em>V</em>.
 * <p>
 * For additional documentation,
 * see <a href="https://algs4.cs.princeton.edu/41SGraph">Section 4.1</a>
...
public class BreadthFirstPaths {
	 ...
	 * {@code sources}
	 * and every other vertex in SGraph {@code G}.
	 *
	 * @param G
	 *                   the SGraph
	 * @param sources
	 *                   the source vertices
	 * @throws IllegalArgumentException
	 *                                     unless {@code 0 <= s < V} for each vertex
